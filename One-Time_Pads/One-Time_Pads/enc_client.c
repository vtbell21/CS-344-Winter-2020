...
int main(int argc, char* argv[]) {
	...
	// Prints error message if key file is too small for text file
	...
	// One extra character is being printed so I delete that character
	int encLength = strlen(Allreceived);
	Allreceived[encLength - 1] = '\0';
